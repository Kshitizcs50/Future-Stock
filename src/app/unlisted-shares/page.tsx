    ...
    <section className="px-6 py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
          Discover top private companies and emerging opportunities, all sorted
          ...
          <table className="w-full border-collapse text-left text-gray-800">
            ...
            <tbody>
              {stocks.map((stock, index) => (
                ...
                >
                  <td className="py-4 px-6 font-medium">{stock.name}</td>
                  ...
                  <td className="py-4 px-6 text-center">
                    <button className="px-5 py-2 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium shadow-md hover:scale-105 transition">
                      Trade Now
                    </button>
                  </td>
                </motion.tr>
